export const standardWeaponsData = {
    firearm: {
        name_key: "standard_weapons.firearm.name",
        about: "standard_weapons.firearm.about",
        skills: {
            basic_attack: {
                name_key: "standard_weapons.firearm.skills.basic_attack.name",
                description_key: "standard_weapons.firearm.skills.basic_attack.description"
            },
            passive_skill: {
    ...
    sword: {
        name_key: "standard_weapons.sword.name",
        about: "standard_weapons.sword.about",
        skills: {
            basic_attack: {
                name_key: "standard_weapons.sword.skills.basic_attack.name",
                description_key: "standard_weapons.sword.skills.basic_attack.description",
    ...
    claymore: {
        name_key: "standard_weapons.claymore.name",
        about: "standard_weapons.claymore.about",
        terms: ['Gathering Stacks', 'Active Skill'],
        skills: {
            basic_attack: {
                name_key: "standard_weapons.claymore.skills.basic_attack.name",
                description_key: "standard_weapons.claymore.skills.basic_attack.description"
            },
            passive_skill: {
